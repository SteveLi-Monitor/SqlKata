...
namespace SqlKata.Tests.SqlAnywhere
{
    public class SelectTests : TestSupport
    {
        ...
        public void BasicSelect()
        {
            ...
            Assert.Equal("SELECT \"id\", \"name\" FROM \"users\"", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void BasicSelectWhereBindingIsEmptyOrNull()
        {
            ...
            Assert.Equal("SELECT \"id\", \"name\" FROM \"users\" WHERE \"author\" = '' OR \"author\" IS NULL", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void BasicSelectWithAlias()
        {
            ...
            Assert.Equal("SELECT \"id\", \"name\" FROM \"users\" AS \"u\"", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void ExpandedSelect()
        {
            ...
            Assert.Equal("SELECT \"users\".\"id\", \"users\".\"name\", \"users\".\"age\" FROM \"users\"", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void ExpandedSelectWithSchema()
        {
            ...
            Assert.Equal("SELECT \"dbo\".\"users\".\"id\", \"dbo\".\"users\".\"name\", \"dbo\".\"users\".\"age\" FROM \"users\"", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void NestedEmptyWhereAtFirstCondition()
        {
            ...
            Assert.Equal("SELECT * FROM \"table\" WHERE \"id\" = 1", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void WhereTrue()
        {
            ...
            Assert.Equal("SELECT * FROM \"Table\" WHERE \"IsActive\" = 1", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void WhereFalse()
        {
            ...
            Assert.Equal("SELECT * FROM \"Table\" WHERE \"IsActive\" = 0", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void OrWhereFalse()
        {
            ...
            Assert.Equal("SELECT * FROM \"Table\" WHERE \"MyCol\" = 'abc' OR \"IsActive\" = 0", c[EngineCodes.SqlAnywhere]);
        ...
        public void OrWhereTrue()
        {
            ...
            Assert.Equal("SELECT * FROM \"Table\" WHERE \"MyCol\" = 'abc' OR \"IsActive\" = 1", c[EngineCodes.SqlAnywhere]);
        ...
        public void OrWhereNull()
        {
            ...
            Assert.Equal("SELECT * FROM \"Table\" WHERE \"MyCol\" = 'abc' OR \"IsActive\" IS NULL", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void WhereSub()
        {
            ...
            Assert.Equal("SELECT * FROM \"Table\" WHERE (SELECT COUNT(*) AS \"count\" FROM \"Table2\" WHERE \"Table2\".\"Column\" = \"Table\".\"MyCol\") = 1", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void OrWhereSub()
        {
            ...
            Assert.Equal("SELECT * FROM \"Table\" WHERE \"MyCol\" IS NULL OR (SELECT COUNT(*) AS \"count\" FROM \"Table2\" WHERE \"Table2\".\"Column\" = \"Table\".\"MyCol\") < 1", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void PassingArrayAsParameter()
        {
            ...
            Assert.Equal("SELECT * FROM \"Table\" WHERE \"Id\" in (1,2,3)", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void Union()
        {
            ...
            Assert.Equal("SELECT * FROM \"Phones\" UNION SELECT * FROM \"Laptops\"", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void UnionWithBindings()
        {
            ...
            Assert.Equal("SELECT * FROM \"Phones\" UNION SELECT * FROM \"Laptops\" WHERE \"Type\" = 'A'", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void CombineRaw()
        {
            ...
            Assert.Equal("SELECT * FROM \"Mobiles\" UNION ALL SELECT * FROM Devices", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void NestedEmptyWhere()
        {
            ...
            Assert.Equal("SELECT * FROM \"A\"", c[EngineCodes.SqlAnywhere]);
        }
        ...
        public void Limit()
        {
            ...
            Assert.Equal("SELECT TOP (10) \"id\", \"name\" FROM \"users\"", c[EngineCodes.SqlAnywhere]);
        }
